...
{
    public partial class EditorFkImage : UserControl, IFkData
    {
        public FkData Data { get; internal set; } = null;

        public EditorFkImage()
        {
            InitializeComponent();
            this.Disposed += EditorFkImage_Disposed;
        }

        private void EditorFkImage_Disposed(object sender, EventArgs e)
        {
            this.Data = null;
        }
